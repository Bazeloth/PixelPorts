...
export const ServerEnvSchema = z.object({
  ...
  SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_ID: z.string().min(1, "Required: SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_ID"),
  SUPABASE_AUTH_EXTERNAL_GOOGLE_SECRET: z.string().min(1, "Required: SUPABASE_AUTH_EXTERNAL_GOOGLE_SECRET"),
});
...
export const ClientEnvSchema = z.object({
  ...
  NEXT_PUBLIC_MIXPANEL_API_HOST: z.string().url("NEXT_PUBLIC_MIXPANEL_API_HOST must be a valid URL"),
