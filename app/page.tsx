                    ...
                    <Container className="mx-auto px-8 py-32 lg:py-40 grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <p className="text-lg text-neutral-500 mb-8 max-w-[480px]">
                                Help emerging designers showcase their work, connect with peers, and
                                get discovered by people who value ideas and execution over clout.
                            </p>
            ...
            {!user && (
                <section className="py-20 bg-gray-900">
                    <Container className="text-center">
                        ...
                        <a
                            className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-3 rounded-lg font-medium transition duration-200 cursor-pointer"
                            href="/signup"
                        >
